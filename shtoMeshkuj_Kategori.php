...
<?php
    if (isset($_POST['submit'])) {
        ...
        if (move_uploaded_file($_FILES["image"]["tmp_name"], $targetFilePath)) {
            $query = $pdo->prepare('INSERT INTO meshkuj (titulli, teksti, image) VALUES (:titulli, :teksti, :image)');
          ...
          return header('Location: dashboardMeshkuj.php');
        }
...
<h1 style="text-align:center;">Kategoria: Meshkuj</h1>
<h2 style="text-align:center;">Forma per regjistrimin e artikujve</h2>
<div id="forma" >
<form method="post" enctype="multipart/form-data">
<h2 style="color:white;text-align:center padding:50px;margin-left:50px">Regjistro artikuj te rinje te kategoria: Meshkuj</h2>
