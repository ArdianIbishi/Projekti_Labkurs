...
$query = $pdo -> query('SELECT * from veturaaksesore');
        ...
        <div id="container">
           ...
           ?>
            ...
            <?php
                 ...
                 ?>
                 <h2 style="margin-left:20px;">Kategoria: Makina Aksesore</h2>
                 </div>
                 <?php
...
$sql= 'SELECT * from veturaaksesore WHERE id = :id';
...
<div id="artikulli1">
                 ...
                 <br>
                 <br>
                 <div><a href="porositVetura_Aksesore.php?id=<?php echo $usera['id'];?>"><div id="klik">Porosit me 1 Klik</div></a> </div>
            ...
            <?php foreach($users as $user):?>
                 ...
                 <div id="artikulli">
                 <a href="kategoriaVetura_Aksesore.php?id=<?php echo $user['id'];?>"style="text-decoration:none;">
