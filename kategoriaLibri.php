        ...
        <div id="container">
           ...
           ?>
            ...
            <?php
                 ...
                 ?>
                 <h2 style="margin-left:20px;">Kategoria: Libri</h2>
                 </div>
                 <?php
...
<div id="artikulli1">
                 ...
                 <br>
                 <br>
                 <div><a href="porositLibri.php?id=<?php echo $usera['id'];?>"><div id="klik">Porosit me 1 Klik</div></a> </div>
            ...
            <?php foreach($users as $user):?>
                 ...
                 <div id="artikulli">
                 <a href="kategoriaLibri.php?id=<?php echo $user['id'];?>"style="text-decoration:none;">
