...
<?php
    if (isset($_POST['submit'])) {
        ...
        if (move_uploaded_file($_FILES["image"]["tmp_name"], $targetFilePath)) {
            $query = $pdo->prepare('INSERT INTO lojrat (titulli, teksti, image) VALUES (:titulli, :teksti, :image)');
          ...
          return header('Location: dashboardElektronike.php');
        }
...
<h1 style="text-align:center;">Kategoria: Elektronike</h1>
