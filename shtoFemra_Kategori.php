...
<?php
    if (isset($_POST['submit'])) {
        ...
        if (move_uploaded_file($_FILES["image"]["tmp_name"], $targetFilePath)) {
            $query = $pdo->prepare('INSERT INTO femra (titulli, teksti, image) VALUES (:titulli, :teksti, :image)');
          ...
          // return header('Location: shfaqlojrat.php');
        }
...
<h1 style="text-align:center;">Kategoria: Femra</h1>
