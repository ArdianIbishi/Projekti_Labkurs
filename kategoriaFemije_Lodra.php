...
$query = $pdo -> query('SELECT * from femijelodra');
        ...
        <div id="container">
           ...
           ?>
            ...
            <?php
                 ...
                 ?>
                 <h2 style="margin-left:20px;">Kategoria: Femije&Lodra</h2>
                 </div>
                 <?php
...
$sql= 'SELECT * from femijelodra WHERE id = :id';
...
<div id="artikulli1">
                 ...
                 <br>
                 <br>
                 <div><a href="porositFemije_Lodra.php?id=<?php echo $usera['id'];?>"><div id="klik">Porosit me 1 Klik</div></a> </div>
            ...
            <?php foreach($users as $user):?>
                 ...
                 <div id="artikulli">
                 <a href="kategoriaFemije_Lodra.php?id=<?php echo $user['id'];?>"style="text-decoration:none;">
