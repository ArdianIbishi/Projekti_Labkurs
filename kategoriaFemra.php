...
$query = $pdo -> query('SELECT * from femra');
...
$sql= 'SELECT * from femra WHERE id = :id';
...
<div id="artikulli1">
                 ...
                 <br>
                 <br>
                 <div><a href="porositFemraKategori.php?id=<?php echo $usera['id'];?>"><div id="klik">Porosit me 1 Klik</div></a> </div>
            ...
            <?php foreach($users as $user):?>
                 ...
                 <div id="artikulli">
                 <a href="kategoriaFemra.php?id=<?php echo $user['id'];?>"style="text-decoration:none;">
