...
$query = $pdo -> query('SELECT * from kujdesipersonal');
        ...
        <div id="container">
           ...
           ?>
            ...
            <?php
                 ...
                 ?>
                 <h2 style="margin-left:20px;">Kategoria: Kujdesi Personal</h2>
                 </div>
                 <?php
...
$sql= 'SELECT * from kujdesipersonal WHERE id = :id';
...
<div id="artikulli1">
                 ...
                 <br>
                 <br>
                 <div><a href="porositKujdesiPersonal.php?id=<?php echo $usera['id'];?>"><div id="klik">Porosit me 1 Klik</div></a> </div>
            ...
            <?php foreach($users as $user):?>
                 ...
                 <div id="artikulli">
                 <a href="kategoriaKujdesiPersonal.php?id=<?php echo $user['id'];?>"style="text-decoration:none;">
