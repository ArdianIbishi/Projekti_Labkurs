...
$query = $pdo -> query('SELECT * from lojrat');
...
$sql= 'SELECT * from lojrat WHERE id = :id';
...
<div id="artikulli1">
                 ...
                 <br>
                 <br>
                 <div><a href="porositElektronike.php?id=<?php echo $usera['id'];?>"><div id="klik">Porosit me 1 Klik</div></a> </div>
            ...
            <?php foreach($users as $user):?>
                 ...
                 <div id="artikulli">
                 <a href="kategoriaElektronike.php?id=<?php echo $user['id'];?>" style="text-decoration:none;">
