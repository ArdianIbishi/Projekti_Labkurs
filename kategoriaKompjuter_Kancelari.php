...
$query = $pdo -> query('SELECT * from kompjuter');
        ...
        <div id="container">
           ...
           ?>
            ...
            <?php
                 ...
                 ?>
                 <h2 style="margin-left:20px;">Kategoria: Kompjuter&Kancelari</h2>
                 </div>
                 <?php
...
$sql= 'SELECT * from kompjuter WHERE id = :id';
...
<div id="artikulli1">
                 ...
                 <br>
                 <br>
                 <div><a href="porostKompjuter_Kancelari.php?id=<?php echo $usera['id'];?>"><div id="klik">Porosit me 1 Klik</div></a> </div>
            ...
            <?php foreach($users as $user):?>
                 ...
                 <div id="artikulli">
                 <a href="kategoriaKompjuter_Kancelari.php?id=<?php echo $user['id'];?>"style="text-decoration:none;">
